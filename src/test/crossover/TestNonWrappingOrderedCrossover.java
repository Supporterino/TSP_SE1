...
import main.crossover.NonWrappingOrderedCrossover;
...
public class TestNonWrappingOrderedCrossover {
    @Test
    public void doCrossover() {

        NonWrappingOrderedCrossover maskedCrossover = new NonWrappingOrderedCrossover();
