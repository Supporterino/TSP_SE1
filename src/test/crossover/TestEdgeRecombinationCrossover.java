...
import main.crossover.EdgeRecombinationCrossover;
...
public class TestEdgeRecombinationCrossover {
    @Test
    public void doCrossover() {

        EdgeRecombinationCrossover maskedCrossover = new EdgeRecombinationCrossover();
