...
import main.crossover.CompleteSubTourExchangeCrossover;
...
public class TestCompleteSubTourExchangeCrossover {
    @Test
    public void doCrossover() {

        CompleteSubTourExchangeCrossover maskedCrossover = new CompleteSubTourExchangeCrossover();
