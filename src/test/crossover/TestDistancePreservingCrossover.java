...
import main.crossover.DistancePreservingCrossover;
...
public class TestDistancePreservingCrossover {

    @Test
    public void doCrossover() {

        DistancePreservingCrossover maskedCrossover = new DistancePreservingCrossover();
