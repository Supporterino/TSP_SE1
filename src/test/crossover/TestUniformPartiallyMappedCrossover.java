...
import main.crossover.UniformPartiallyMappedCrossover;
...
public class TestUniformPartiallyMappedCrossover {
    @Test
    public void doCrossover() {

        UniformPartiallyMappedCrossover maskedCrossover = new UniformPartiallyMappedCrossover();
